object fControlRoomReport: TfControlRoomReport
  Left = 192
  Top = 114
  AutoScroll = False
  BorderIcons = []
  Caption = 'fControlRoomReport'
  ClientHeight = 387
  ClientWidth = 506
  Color = clBtnFace
  ...
  object qreport: TQuery
    ...
    object roomName: TStringField
      DisplayLabel = 'Room Name'
      FieldName = 'roomName'
      Origin = 'VIZTA.tControlRoom.roomName'
      Size = 255
    end
    object qreportapa: TStringField
      DisplayLabel = 'Status'
      FieldName = 'apa'
      Size = 255
    end
  end
  object rvControlRoom: TRvDataSetConnection
